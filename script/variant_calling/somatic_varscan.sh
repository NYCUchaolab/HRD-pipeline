...
./varscan_result/${normal}.pileup ./varscan_result/${tumor}.pileup ${label}_somatic --output-vcf --min-var-freq 0.05
# step3
java -jar $varscan processSomatic ${label}_somatic.snp.vcf --min-tumor-freq 0.05
java -jar $varscan processSomatic ${label}_somatic.indel.vcf --min-tumor-freq 0.05
